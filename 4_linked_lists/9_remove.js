...
class LinkedList {
  ...
  // -- Steps to remove method --
  // Find node at specified index and remove it
  // Update length
  // Return removed node
  // -- Edge Cases --
  // Index < 0 || index > length || length===0
  // If length 1
  // -- Reusable methods --
  // If index 0, use shift method
  // if index === length, use pop
  // get method to find node at index before target index
  remove(index) {
